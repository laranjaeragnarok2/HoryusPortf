...
const projectsMain: RetroProject[] = [
  ...
  {
    title: "JDE Sovereign Portal",
    description: "Portal empresarial digital construído com tecnologias modernas. Interface corporativa de alto padrão.",
  ...
  {
    title: "Skarner // Battlecast Protocol",
    description: "IA de elite para engenharia tática e automação local. Monitora projetos, rastreia commits e elimina ineficiências.",
    tags: ["Python", "Automação", "OpenClaw"],
